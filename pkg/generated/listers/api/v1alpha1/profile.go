...
type ProfileLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha1.Profile, err error)
...
type profileLister struct {
	listers.ResourceIndexer[*apiv1alpha1.Profile]
}

// NewProfileLister returns a new ProfileLister.
func NewProfileLister(indexer cache.Indexer) ProfileLister {
	return &profileLister{listers.New[*apiv1alpha1.Profile](indexer, apiv1alpha1.Resource("profile"))}
}

// Profiles returns an object that can list and get Profiles.
func (s *profileLister) Profiles(namespace string) ProfileNamespaceLister {
	return profileNamespaceLister{listers.NewNamespaced[*apiv1alpha1.Profile](s.ResourceIndexer, namespace)}
}
...
type ProfileNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha1.Profile, error)
