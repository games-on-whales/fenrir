...
import (
	v1alpha1 "games-on-whales.github.io/direwolf/pkg/generated/clientset/versioned/typed/api/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeDirewolfV1alpha1 struct {
	*testing.Fake
}

func (c *FakeDirewolfV1alpha1) Apps(namespace string) v1alpha1.AppInterface {
...
func (c *FakeDirewolfV1alpha1) RESTClient() rest.Interface {
